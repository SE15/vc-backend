...
router.post('/users/:userid/connections/:recipientid',authorization, userController.addConnection);
router.put('/users/:userid/connections/:connectionid',authorization, userController.respondConnection);
router.delete('/users/:userid/connections/:recipientid', authorization, userController.removeConnection);
router.post('/users/:userid/recommendations/:recipientid', authorization, userController.submitRecommendation);
